...
def train():
    ...
    with tf.Session(config=config_proto) as sess:
        ...
        for epoch_idx in range(FLAGS.max_epochs):
            ...
            for keywordes, keyword_lengths, contents,content_lengths,targets, target_lengths,keyword_teams,keyword_teams_lengths in gen_batch_train_data(FLAGS.batch_size,
                ...
                step_loss, summary = model.train(
                    ...
                    keyword_teams=keyword_teams,
                    keyword_teams_lengths=keyword_lengths
                )
